...
export function TarotCard({ project, index }: TarotCardProps) {
  ...
  return (
    ...
    >
      <InteractiveCardTilt maxTilt={12} className="h-full w-full">
        <div
          className={cn(
            "relative h-full overflow-hidden rounded-xl border-2 bg-linear-to-b p-1.75 transition-shadow duration-500 [transform-style:preserve-3d]",
            project.border,
            project.gradient,
        ...
        >
          <div className="relative flex h-full flex-col overflow-hidden rounded-lg border border-amber-500/20 bg-surface/95 [transform-style:preserve-3d]">
            ...
            <header className="px-5 pt-5 text-center [transform:translateZ(10px)]">
              <p
                className={cn(
            ...
            <div className="relative mx-5 my-3 flex flex-1 items-center justify-center [transform:translateZ(22px)]">
              ...
              <div className="relative z-10 h-32 w-32 overflow-hidden rounded-full">
                <Image
                  ...
                  fill
                  sizes="128px"
                  className="object-cover mix-blend-screen drop-shadow-[0_0_10px_rgba(255,255,255,0.25)]"
                />
              </div>
            </div>

            <footer className="relative mx-3 mb-3 rounded-md border border-accent-amber/15 bg-surface-elevated/80 px-4 py-3 text-center [transform:translateZ(14px)]">
